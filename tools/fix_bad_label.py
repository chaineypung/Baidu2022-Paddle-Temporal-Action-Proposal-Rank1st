...
url = '/home/aistudio/data/Features_competition_train/npy/'
...
with open('/home/aistudio/data/n_label_cls14_train.json') as f:
    data = json.load(f)
...
jsonFile = open('/home/aistudio/data/new_label_cls14_train.json', 'w')
